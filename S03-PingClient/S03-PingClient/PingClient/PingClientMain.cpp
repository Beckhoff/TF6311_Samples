...
class CPingClientCtrl : public ITcOCFCtrlImpl<CPingClientCtrl, CPingClientClassFactory>
{
public:
	CPingClientCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("PingClient: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CPingClientCtrl>;
