...
class CTcpClientCtrl : public ITcOCFCtrlImpl<CTcpClientCtrl, CTcpClientClassFactory>
{
public:
	CTcpClientCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("TcpClient: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CTcpClientCtrl>;
