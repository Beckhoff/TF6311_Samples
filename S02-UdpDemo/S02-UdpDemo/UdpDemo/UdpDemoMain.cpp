...
class CUdpDemoCtrl : public ITcOCFCtrlImpl<CUdpDemoCtrl, CUdpDemoClassFactory>
{
public:
	CUdpDemoCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("UdpDemo: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CUdpDemoCtrl>;
